...
void FeCMove(FieldElement f, FieldElement g, int b) {
  ...
  var f8 = Int32(f[8]);
  var f9 = Int32(f[9]);
  f[0] = (f0 ^ (int32b & (f[0] ^ g[0]))).toInt();
  f[1] = (f1 ^ (int32b & (f[1] ^ g[1]))).toInt();
  f[2] = (f2 ^ (int32b & (f[2] ^ g[2]))).toInt();
  f[3] = (f3 ^ (int32b & (f[3] ^ g[3]))).toInt();
  f[4] = (f4 ^ (int32b & (f[4] ^ g[4]))).toInt();
  f[5] = (f5 ^ (int32b & (f[5] ^ g[5]))).toInt();
  f[6] = (f6 ^ (int32b & (f[6] ^ g[6]))).toInt();
  f[7] = (f7 ^ (int32b & (f[7] ^ g[7]))).toInt();
  f[8] = (f8 ^ (int32b & (f[8] ^ g[8]))).toInt();
  f[9] = (f9 ^ (int32b & (f[9] ^ g[9]))).toInt();
}
...
void ScMulAdd(Uint8List s, Uint8List a, Uint8List b, Uint8List c) {
  ...
  s11 += s23 * Int64s.v666643;
  s12 += s23 * Int64s.v470296;
  s13 += s23 * Int64s.v654183;
  s14 -= s23 * Int64s.v997805;
  s15 += s23 * Int64s.v136657;
  s16 -= s23 * Int64s.v683901;
  s23 = Int64.ZERO;

  s10 += s22 * Int64s.v666643;
  s11 += s22 * Int64s.v470296;
  s12 += s22 * Int64s.v654183;
  s13 -= s22 * Int64s.v997805;
  s14 += s22 * Int64s.v136657;
  s15 -= s22 * Int64s.v683901;
  s22 = Int64.ZERO;

  s9 += s21 * Int64s.v666643;
  s10 += s21 * Int64s.v470296;
  s11 += s21 * Int64s.v654183;
  s12 -= s21 * Int64s.v997805;
  s13 += s21 * Int64s.v136657;
  s14 -= s21 * Int64s.v683901;
  s21 = Int64.ZERO;

  s8 += s20 * Int64s.v666643;
  s9 += s20 * Int64s.v470296;
  s10 += s20 * Int64s.v654183;
  s11 -= s20 * Int64s.v997805;
  s12 += s20 * Int64s.v136657;
  s13 -= s20 * Int64s.v683901;
  s20 = Int64.ZERO;

  s7 += s19 * Int64s.v666643;
  s8 += s19 * Int64s.v470296;
  s9 += s19 * Int64s.v654183;
  s10 -= s19 * Int64s.v997805;
  s11 += s19 * Int64s.v136657;
  s12 -= s19 * Int64s.v683901;
  s19 = Int64.ZERO;

  s6 += s18 * Int64s.v666643;
  s7 += s18 * Int64s.v470296;
  s8 += s18 * Int64s.v654183;
  s9 -= s18 * Int64s.v997805;
  s10 += s18 * Int64s.v136657;
  s11 -= s18 * Int64s.v683901;
  s18 = Int64.ZERO;
  ...
  s5 += s17 * Int64s.v666643;
  s6 += s17 * Int64s.v470296;
  s7 += s17 * Int64s.v654183;
  s8 -= s17 * Int64s.v997805;
  s9 += s17 * Int64s.v136657;
  s10 -= s17 * Int64s.v683901;
  s17 = Int64.ZERO;

  s4 += s16 * Int64s.v666643;
  s5 += s16 * Int64s.v470296;
  s6 += s16 * Int64s.v654183;
  s7 -= s16 * Int64s.v997805;
  s8 += s16 * Int64s.v136657;
  s9 -= s16 * Int64s.v683901;
  s16 = Int64.ZERO;

  s3 += s15 * Int64s.v666643;
  s4 += s15 * Int64s.v470296;
  s5 += s15 * Int64s.v654183;
  s6 -= s15 * Int64s.v997805;
  s7 += s15 * Int64s.v136657;
  s8 -= s15 * Int64s.v683901;
  s15 = Int64.ZERO;

  s2 += s14 * Int64s.v666643;
  s3 += s14 * Int64s.v470296;
  s4 += s14 * Int64s.v654183;
  s5 -= s14 * Int64s.v997805;
  s6 += s14 * Int64s.v136657;
  s7 -= s14 * Int64s.v683901;
  s14 = Int64.ZERO;

  s1 += s13 * Int64s.v666643;
  s2 += s13 * Int64s.v470296;
  s3 += s13 * Int64s.v654183;
  s4 -= s13 * Int64s.v997805;
  s5 += s13 * Int64s.v136657;
  s6 -= s13 * Int64s.v683901;
  s13 = Int64.ZERO;

  s0 += s12 * Int64s.v666643;
  s1 += s12 * Int64s.v470296;
  s2 += s12 * Int64s.v654183;
  s3 -= s12 * Int64s.v997805;
  s4 += s12 * Int64s.v136657;
  s5 -= s12 * Int64s.v683901;
  s12 = Int64.ZERO;
